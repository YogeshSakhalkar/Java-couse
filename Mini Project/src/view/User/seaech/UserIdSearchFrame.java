...
import Controller.User.UserSearch.UserIdSearchController;

public class UserIdSearchFrame extends Frame{
 
	Button btSubmit,btClear,btBack;
	TextField txtId;
	Label lbId;
	
	public UserIdSearchFrame() {
		...
		UserIdSearchController u1 = new UserIdSearchController(this);
