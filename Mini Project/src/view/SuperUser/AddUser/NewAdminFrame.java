...
import Controller.SuperUser.UserAdd.AddAdminController;

public class NewAdminFrame extends Frame{
	...
	public NewAdminFrame() {
		...
		AddAdminController aa1 = new AddAdminController(this);
		btSubmit.addActionListener(aa1);
		btClear.addActionListener(aa1);
		btBack.addActionListener(aa1);
	}
